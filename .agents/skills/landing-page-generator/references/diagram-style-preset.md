...
flowchart TB
    ...
    C --> E["🤖 개발팀<br/>클로드 스킬 + 파이썬<br/>───<br/>05-prompt.md<br/>Codex 이미지 생성 프롬프트 13개"]

    D --> E

    E --> F["🐍 스크립트 실행<br/>───<br/>image_api.py<br/>stitch_images.py"]

    F --> G["🖼️ 최종 결과물<br/>───<br/>상세페이지 PNG/PDF<br/>1200px × 7500px"]
